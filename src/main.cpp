...
int main(void) {
	...
	bool inFlight = false;
	float JumpEnergy = 0;
	Object scene_Objects[9] = {{{20, 0, 20}, 10}, {{20, 10, 0}, 10}, {{0, 20, 20}, 10}, {{20, 30, 20}, 10}, {{20, 40, 0}, 10}, {{0, 40, 20}, 10}, {{40, 40, 20}, 10}, {{80, 40, 0}, 10}, {{120, 40, 20}, 10}};
